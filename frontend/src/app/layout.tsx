...
export default function RootLayout({
  ...
  return (
    <html lang="es" className="dark">
      <body className={`${jakarta.className} bg-[#020617] text-slate-200 antialiased selection:bg-blue-500/30`}>
        ...
        <div className="flex flex-col md:flex-row h-screen w-screen p-2 md:p-6 gap-2 md:gap-6 overflow-hidden">
          <Sidebar />
